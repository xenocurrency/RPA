...
class ReplyBot:
    ...
    # 태그 검색 화면에서 인기게시글 첫 번째 사진을 골라 클릭합니다.
    def select_picture(self):
        #각 게시글을 나타내는 클래스 이름이 "_aagw"입니다
        ...
        while count != 0:
            ...
            for el in svg:
                ...
                if el.get_attribute("aria-label") == "좋아요":
                    ...
                    count -= 1
                    break
            # 다음 게시물로 넘어갑시다. 다음 버튼에는 CLASS NAME 이 "_abl-"로 기재되어 있습니다. 요소를 찾습니다.
